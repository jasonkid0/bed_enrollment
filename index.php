...
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_US/sdk.js#xfbml=1&version=v11.0" nonce="sSX03XeH"></script>
    ...
    <nav class="panel top">
        <div class="sections desktop">
            <div class="left"><a href="https://www.stfrancisbacoor.com" title="SFAC Bacoor Portal"><img height="75" width="75" src="assets/img/logo.png"
                        alt="logo-left"></a></div>
            <div class="center">
                <ul class="menu uppercase">
                    <li><a href="#">HOME</a></li>
                    <li><a href="#Enroll">Registration Form</a></li>
    ...
    <nav class="sidebar" data-sidebar-id="1">
        ...
        <div class="content">
            <a href="#" title="stfrancisbacoor/BED"><img height="75" width="75" src="assets/img/logo.png"
                        alt="logo-left"></a>
              ...
              <input type="password" class="input-9 ae-6 fromCenter" name="confirm-password"
                placeholder="Confirm the password" val="" />
                        ...
                        <form method="POST" action="bed/pages/bed-login/login.php">
                           ...
                           <!--  <button type="submit" class="button blueGray gradient ae-7 fromCenter" name="button" disabled="true">Create
                                an
                                account</button> -->
                        </form>
                    </div>
                ...
                <div class="wrap">
                    ...
                    <div class="fix-12-12">
                        <div class="fix-8-12 left toRight">
                            <h1 class="ae-1">Inquire/Register Now | <b>Be one of us</b></h1>
                            <p class="ae-2 h4"><span class="opacity-8"></span></p>
                            <ul class="flex">
                                <li class="col-6-12 ae-3">
                                    <h3 class="margin-top-3">Pre-School (N, PK, K)</h3>
                                    <a href="bed/pages/bed-online-enrollment/online_enrollment_ps.php"
                                        data-toggle="tooltip" title="Nursery, Pre-Kinder and Kinder"><img
                                            src="assets/img/PS.jpg" class="wide rounded" alt="Video Thumbnail" /></a>
                                </li>
                                <li class="col-6-12 ae-4">
                                    <h3 class="margin-top-3">Elementary (G1 to G6)</h3>
                                    <a href="bed/pages/bed-online-enrollment/online_enrollment_gs.php"
                                        data-toggle="tooltip" title="Grade 1 to 6"><img src="assets/img/GS.jpg"
                                            class="wide rounded" alt="Video Thumbnail" /></a>
                                </li>
                                <li class="col-6-12 ae-5">
                                    <h3 class="margin-top-3">Junior High School (G7 to G10)</h3>
                                    <a href="bed/pages/bed-online-enrollment/online_enrollment_jhs.php"
                                        data-toggle="tooltip" title="Grade 7 to 10"><img src="assets/img/JHS.jpg"
                                            class="wide rounded" alt="Video Thumbnail" /></a>
                                </li>
                                <li class="col-6-12 ae-6">
                                    <h3 class="margin-top-3">Senior High School (G11 to G12)</h3>
                                    <a href="bed/pages/bed-online-enrollment/online_enrollment_shs.php"
                                        data-toggle="tooltip" title="Grade 11 and Grade 12"><img src="assets/img/shs1.jpg"
                                            class="wide rounded" alt="Video Thumbnail" /></a>
                                </li>
                            </ul>
                        </div>
        ...
        <div class="content">
            <div class="container">
                <div class="wrap">
                    ...
                    <div class="fix-12-12">
                        <div class="fix-8-12 left toRight">
                            <h1 class="ae-1">K to 12 Program</h1>
                            ...
                            <a class="button blue gradient crop ae-3" href="#">More</a>
                        </div>
                    </div>
    ...
    <section class="slide fade-6 kenBurns fromLeft" id="ourLocation">
        <div class="content">
            <div class="container">
                <div class="wrap">
  ...
  height: 0;}</style></div>
        ...
        <div class="background" style="background-image:url(assets/img/background/walkway.jpg)"></div>
    </section>


    <section class="slide fade-6 kenBurns fromLeft" id="contactUs">
        <div class="content">
            <div class="container">
                <div class="wrap">
                    ...
                    <div class="fix-12-12">
                        <div class="fix-8-12 left toRight">
                            <h1 class="ae-1">Contact Us</h1>
                          <p class="ae-2 h4"><span class="opacity-12">
                    <strong>Principal's Office</strong><br>          
                    Telephone: (046) 537-0619<br>
                    Email: charlie_fajut@yahoo.com<br>
                    Office Hours: 7:00 A.M. to 4:00 P.M.<br><br>

                    <strong>Admission Office</strong><br>
                    Telephone: (046) 501-1135<br>
                    Mobile: 0969-0800657 (Basic Ed.)<br>
                    Email: admissions.sfacbacoor@gmail.com<br>
                    Mobile: 0915-7244040 (College )<br>
                    Office Hours: 8:00 A.M. to 4:00 P.M.<br><br>

                    <strong>Accounting Office</strong><br>
                    Telephone: (046) 501-1138 <br>
                    ...
                    Tel #: (046) 424-5796 <br>
                    Mobile: 0949-8964343 <br>
                    Email: edmieian1325@yahoo.com<br>
                    Office Hours: 8:00 A.M. to 4:00 P.M.<br><br>
                    
                    

                </p>
                <h1 class="ae-2">Message Us</h1>
                <li class="col-1-12">&nbsp;</li>
                            <li class="col-5-12 bottom">
                                <div class="fb-page" data-href="https://www.facebook.com/mysfacbacoor/" data-tabs="messages" data-width="" data-height="" data-small-header="true" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true"><blockquote cite="https://www.facebook.com/mysfacbacoor/" class="fb-xfbml-parse-ignore"><a href="https://www.facebook.com/mysfacbacoor/">Saint Francis of Assisi College - Bacoor Campus</a></blockquote></div>
                            </li>
                            <!-- <a class="button blue gradient crop ae-3" href="#">More</a> -->
                        </div>
                    </div>
        ...
        <div class="background" style="background-image:url(assets/img/background/pathwayPreSch.jpg)"></div>
    </section>
 ...
 -->
   ...
   <!<section class="slide fade-6 kenBurns">
    ...
    <nav class="panel bottom lastSlideOnly">
        <div class="sections">
            <div class="center">
                <a href="#" class="opacity-8">Go to top</a>
            </div>
        </div>
    </nav>
