...
if (isset($_POST['submit'])) {
    ...
    if ($result > 0) {
        ...
        header('location: ../edit.subSchedPJH.php?sub_id=' . $_SESSION['sub_id'] . '&sched_id=' . $_SESSION['sched_id']);
    } else {
        $insert = mysqli_query($conn, "UPDATE tbl_schedules SET day = '$days', time = '$time', room = '$room', teacher_id = '$instruct' WHERE subject_id = '$sub_id' AND acadyear = '$acadyear' AND schedule_id = '$_SESSION[sched_id]'") or die(mysqli_error($conn));
