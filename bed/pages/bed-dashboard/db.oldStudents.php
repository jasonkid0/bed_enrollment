        ...
        <nav class="main-header navbar navbar-expand navbar-dark">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="#" class="nav-link disabled text-light">Old Students</a>
                            ...
                            <div class="col-12">
                                <div class="card shadow">
                                    <div class="card-header bg-navy p-3">
                                        <h3 class="card-title text-lg">List of Enrolled Old Students </h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <div class="card-body">
...
if (isset($_GET['look'])) {
    ...
    $get_enrolled_stud = mysqli_query($conn, "SELECT *, CONCAT(stud.student_lname, ', ', stud.student_fname, ' ', stud.student_mname) AS fullname
                                                ...
                                                AND stud_type = 'Old'
                                                AND ay.academic_year = '$_SESSION[active_acadyears]'
