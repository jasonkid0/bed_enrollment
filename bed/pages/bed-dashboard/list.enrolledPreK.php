                            ...
                            <div class="col-12">
                                <div class="card shadow">
                                    <div class="card-header bg-navy p-3">
                                        <h3 class="card-title text-lg">List of Enrolled Students in Pre-kinder</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <div class="card-body">
                                            ...
                                            <div class="col-md-3 col-sm-6 col-6">
                                                <div class="info-box">
                                                    ...
                                                    <div class="info-box-content">
                                                        ...
                                                        WHERE ay.academic_year = '$_SESSION[active_acadyears]' AND semester_id = '0' AND remark = 'Approved' AND grade_level_id = '2' AND stud_type = 'New'") or die(mysqli_error($conn));
                                            ...
                                            <div class="col-md-3 col-sm-6 col-6">
                                                <div class="info-box">
                                                    ...
                                                    <div class="info-box-content">
                                                        ...
                                                        <?php $stud_count = mysqli_query($conn, "SELECT count(student_id) AS total_stud FROM tbl_schoolyears AS sy
                                                        LEFT JOIN tbl_acadyears AS ay ON ay.ay_id = sy.ay_id
                                                        WHERE ay.academic_year = '$_SESSION[active_acadyears]' AND semester_id = '0' AND remark = 'Approved' AND grade_level_id = '2' AND stud_type = 'Old'") or die(mysqli_error($conn));
                                                        while ($row = mysqli_fetch_array($stud_count)) { ?>
                                                        <span
                                                            class="info-box-number"><?php echo $row['total_stud']; ?></span>
                                                        <?php } ?>
                                        ...
                                        <table id="example2" class="table table-hover">
                                            ...
                                            <tbody class="border-bottom">
                                                ...
                                                LEFT JOIN tbl_acadyears AS ay ON ay.ay_id = sy.ay_id  
                                                WHERE ay.academic_year = '$_SESSION[active_acadyears]' AND semester_id = '0' AND remark = 'Approved' AND sy.grade_level_id = '2'
