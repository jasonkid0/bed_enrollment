        ...
        <nav class="main-header navbar navbar-expand navbar-dark">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="#" class="nav-link disabled text-light">New Students</a>
                            ...
                            <div class="col-12">
                                <div class="card shadow">
                                    <div class="card-header bg-navy p-3">
                                        <h3 class="card-title text-lg">List of Enrolled New Students </h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <div class="card-body">
                                        ...
                                        <table id="example2" class="table table-hover">
                                            ...
                                            <tbody class="border-bottom">
                                                ...
                                                WHERE remark = 'Approved' AND stud_type = 'New' AND ay.academic_year = '$_SESSION[active_acadyears]' AND (sem.semester = '$_SESSION[active_semester]' OR sy.semester_id = '0')    
