...
$pdf->SetFont('Arial', '', 8);
$pdf->Cell(6, 5, '', 0, 0);
$pdf->Cell(26, 3, 'PLACE OF BIRTH:', 0, 0);
$pdf->Cell(30, 3, '', 'B', 0, 'C');
...
$pdf->Cell(2, 5, '', 0, 0);
$pdf->Cell(23, 3, 'F.OCCUPATION:', 0, 0);
$pdf->Cell(30, 3, '', 'B', 0, 'C');
...
$pdf->Cell(2, 5, '', 0, 0);
$pdf->Cell(23, 3, 'M.OCCUPATION:', 0, 0);
$pdf->Cell(30, 3, '', 'B', 0, 'C');
...
$pdf->Cell(155, 4, 'PERSONAL INFORAMTION', 1, 1, 'C');
...
$pdf->SetFont('Arial', '', 9);
$pdf->Cell(142, 5, 'CERTIFICATE OF REGISTRATION AND STUDENTS INFORAMTION', 1, 0, 'C');
$pdf->Cell(10, 5, '', 0, 1);
...
$pdf->Cell(35, 3, '', 0, 0, 'C');
$pdf->Cell(135, 3, '', 0, 1, 'C');
$pdf->Cell(155, 3, '', 'B', 1, 'C');

$pdf->SetFont('Arial', '', 8);
$pdf->Cell(.1, 12.5, "", 'R', 0);
$pdf->Cell(10, 10, 'ADDRESS:', 0, 1);
$pdf->Cell(136, 3, '', 'B', 1, 'L');
