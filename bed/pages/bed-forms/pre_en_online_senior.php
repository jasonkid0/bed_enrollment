...
$pdf->Cell(2,5,$row['grade_level'] .' - '. $row['strand_name'],'',1,'C');
...
$pdf ->Cell(3,2,'',0,0);
$pdf->Cell(20,4,'Place of Birth ',0,0);
$fontsize = 11;
$tempFontSize = $fontsize;
$cellwidth = 48;
...
$pdf->Cell(50,4,$row['place_birth'],'B',0,'C');
$pdf ->Cell(4 ,2,'',0,0);
$pdf->SetFont('Arial','B',8);
$pdf->Cell(10,4,'Age',0,0);
$pdf->SetFont('Arial','B',9);
$pdf->Cell(40,4,$row['age'],'B',0,'C');
...
$pdf ->Cell(2 ,2,'',0,0);
$pdf->Cell(21,4,'Citizenship',0,0);
$pdf->Cell(50,4,$row['nationality'],'B',0,'C');
$pdf ->Cell(3 ,2,'',0,0);
...
$pdf->Cell(175,4,$row['email'],'B',1,'L
    ');
