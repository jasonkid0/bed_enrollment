...
$pdf->Image('../../../assets/img/logo.jpg', 25, 9, 15, 15);
$pdf->Image('../../../assets/img/logo1.jpg', 125, 9, 15, 15);
...
$pdf->Cell(155, 7.5, 'Registration Form for Accounting Office', 0, 1, 'C');
...
if (!empty($row['section'])) {
    $pdf->Cell(15, 8, utf8_decode($row['section']), 0, 0, 'C');
} else {
    $pdf->Cell(15, 8, 'TBA', 0, 0, 'C');
}
...
$pdf->Ln(1);
$pdf->Cell(15.5, 3, 'Full Name:', 0, 0);
$pdf->Cell(60, 3, utf8_decode($row['fullname']), 0, 0, 'C');
$pdf->Cell(4, 8, '', 0, 0);
